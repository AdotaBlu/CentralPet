...
<div class = "container-main">
	...
	<div class="principal">
		...
		<div class="container-tela-adocao-pet-texto">
			<div class="bloco-direita-texto">O que é Adoção Responsável? De
				...
				necessidades, características e particularidades.</div>
			...
			<div class="container-tela-adocao-pet-texto">
				...
				animal. -Outro fator crucial é o tutor ter um espaço adequado para o
				...
				para se proteger da chuva e do frio. -Um pet demanda tempo, então
				...
				seu dia para dedicar ao seu pet. -Além disso, terá que ter um
