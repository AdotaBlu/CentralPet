...
<body>
	...
	<main >
		...
		<form method="post" action="cadastrar-tutor" enctype="multipart/form-data" class="container-grid">
			<div class="container-cadastro-tudo-tutor" id="container-cadastro-tudo">
				<div class="container-cadastro-endereco" id="container-cadastro-endereco">
					
					<div class="container-infos-endereco-e-foto">
					
						<div class="container-cadastro-foto">
						...
						<input type="hidden" id="id-endereco" name="id-endereco" value="<c:out value='${endereco.id}' />">
							...
							<div class="container-infos-endereco">
					...
					<div class="container-botao-cadastro-endereco">
					
						<div class="container-botao-voltar-cadastro">
							<button type="button" class="botao-cadastro-voltar" onclick="voltarCadastro()">Voltar</button>
						</div>
						
						<div class="container-botao-salvar-cadastro">
							<button type="submit" class="botao-cadastro" id="">Salvar</button>
						</div>
			...
			<div class="container-cadastro-usuario" id="container-cadastro-usuario">
				...
				<div class="container-senha-cadastro">
					...
					<div class="input-cadastro-confirmar">
				...
				<div class="container-botao-cadastro">
					...
					<button type="button" class="botao-cadastro" id="botao-continuar-cadastro" onclick="continuarCadastro()">Continuar</button>
				</div>
