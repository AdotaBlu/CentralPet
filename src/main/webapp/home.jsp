...
<body>
	...
	<div class="conteinerHome">
		...
		<div class="conteiner-secao">
			<b><p>Dê o primeiro passo para encontrar 
			seu novo amigo peludo! Nesta etapa, 
			explore os pets disponíveis para 
			adoção. Veja suas fotos, leia suas 
			histórias e descubra qual deles toca 
			seu coração.</p></b>
				 
			<b><p>Já foram adotados pela central pet até agora.</p></b>
