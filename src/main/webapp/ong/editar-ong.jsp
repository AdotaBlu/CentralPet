...
<body>
	...
	<div class="container-geral">
		...
		<form method="post" action="atualizar-ong" enctype="multipart/form-data" class="form-editar-perfil">
		
			<div class="container-editar">
				
				<div class="editar-foto-perfil" id="etapa-um">
					<label class="label-editar-foto" for="foto-perfil">Foto de Perfil</label> 
					<img alt="foto-perfil-ong" class="editar-foto-perfil" src="<c:out value="${ongSessao.urlFoto()}"></c:out>">
				...
				<div class="editar-infos-perfil" id="etapa-um-parte-dois">
					...
					<div class="grupo-inputs">
						...
						<input type="text" id="cpf" name="cnpj" value="<c:out value='${ongSessao.cnpj}' />">
					</div>
				...
				<div class="container-editar-endereco" id="etapa-dois">
					...
					<div class="grupo-inputs-endereco">
    					...
    					<select name="bairro" id="bairro-editar-endereco" value='<c:out value="${tutorSessao.bairro}">${tutorSessao.bairro}</c:out>'>
