...
<body>
	...
	<main>
		...
		<form method="post" action="cadastrar-pet"enctype="multipart/form-data" class="container-grid-pet">
			...
			<div class="container-cadastro-infos">
				...
				<div class="container-botao-pet">
        			...
        			<button type="submit" class="botao-cadastro-pet">Cadastrar</button>		
           		</div>
